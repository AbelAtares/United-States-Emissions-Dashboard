...
An interactive dashboard designed to explore greenhouse gas (GHG) emissions across counties in the United States, using publicly available EPA data from 2023.

---

## 📊 About the Data

This dashboard is based on emissions data collected by the Environmental Protection Agency (EPA), covering **3,142 counties across the US**.
...
- How emissions relate to population size  
- Which states and counties contribute the most  
- Where emissions are unusually high compared to population  
...
- **Geographic hotspots**: Certain regions (e.g., Texas, Florida) stand out  
- **Inequality**: A few counties contribute disproportionately  
...
- Review **top states and counties** to understand concentration  
- Apply insights for **analysis, reporting, or decision-making**  
